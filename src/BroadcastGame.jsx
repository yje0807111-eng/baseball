...
import {
  createGame, pitch, pitchMix, batterOf, pitcherOf, offenseOf, defenseOf, RESULT_LABEL, PITCHES, replaceTeam, aiPitchingChange, DEFAULT_USAGE, dirName } from './engine/pitchSim.js';
    ...
    <div className="fixed inset-0 z-40 select-none overflow-hidden bg-[#05080f] text-gray-200"
      ...
      <div className="grid h-full" style={{ gridTemplateRows: '63px 1fr' }}>
        ...
        <div className="grid min-h-0 gap-3 p-3" style={{ gridTemplateColumns: '300px 1fr 320px' }}>
          ...
          {/* ── 가운데: 구장 ── */}
          <div className="grid min-h-0" style={{ gridTemplateRows: '1fr' }}>
