  ...
  render() {
    ...
    return (
      <div style={{ minHeight: '100dvh', background: '#05080f', color: '#e8ecf2', padding: 32, fontFamily: "'IBM Plex Sans KR',sans-serif" }}>
        <h1 style={{ fontSize: 22, fontWeight: 900, color: '#fca5a5', margin: '0 0 6px' }}>화면을 그리다 멈췄습니다</h1>
        <p style={{ margin: '0 0 16px', fontSize: 14, color: '#9ca3af' }}>아래 내용을 그대로 알려 주시면 고칠 수 있습니다.</p>
