  ...
  render() {
    ...
    return (
      <div style={{ minHeight: '100dvh', background: '#05080f', color: '#e8ecf2', padding: 32, fontFamily: "'IBM Plex Sans KR',sans-serif" }}>
        <h1 style={{ fontSize: 18, fontWeight: 900, color: '#fca5a5', margin: '0 0 6px' }}>화면을 그리다 멈춤</h1>
        <p style={{ margin: '0 0 16px', fontSize: 14, color: '#9ca3af' }}>아래 내용 그대로 알려 주기</p>
        <pre style={{ whiteSpace: 'pre-wrap', wordBreak: 'break-word', background: 'rgba(248,113,113,.08)', boxShadow: 'inset 0 0 0 1px rgba(248,113,113,.4)', padding: 16, fontSize: 14, lineHeight: 1.6, color: '#fecaca' }}>
