...
const PASSIVE_AUGMENTS = [
  ...
  { id: 'sprintTrain', name: '주루 특훈', tier: 'silver', type: 'build', desc: '타자 주루 +12 · 주루 비중 +50%',
    note: '한 베이스를 더 가고 도루가 늘어남',
    roster: (r) => bump(r, isBat, { speed: 12 }),
    team: (t) => { t.weights.speed += 0.1; } },
  ...
  { id: 'speedRevolution', name: '발야구', tier: 'silver', type: 'extreme', desc: '타자 주루 +35 · 파워 −8 · 주루 비중 +50%',
  ...
  { id: 'setterUp', name: '테이블세터', tier: 'silver', type: 'build', desc: '주루 상위 4명 주루 +25 · 주루 비중 +50%',
