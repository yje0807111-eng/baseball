...
const PASSIVE_AUGMENTS = [
  ...
  { id: 'trainerOn', name: '트레이너 상주', tier: 'silver', type: 'play', desc: '선발 능력치 +4 · 지치는 이닝에도 감점 없음',
  ...
  { id: 'posFree', name: '포지션 파괴', tier: 'silver', type: 'balance', desc: '제자리가 아닌 선수의 종합 감소 없음 · 야수 수비 +5',
  ...
  { id: 'hometownFans', name: '연고지 응원', tier: 'silver', type: 'build', desc: '한 구단에서 3명 이상 뽑았으면 그 구단 선수 능력치 +4',
  ...
  { id: 'rookieHunger', name: '무명의 반란', tier: 'silver', type: 'balance', desc: '종합 70 미만 선수 능력치 +2',
    roster: (r) => bump(r, (p) => p.overall < 70, every(2)) },
  { id: 'veteran', name: '베테랑의 품격', tier: 'silver', type: 'build', desc: '종합 88 이상 선수 능력치 +5',
  ...
  { id: 'catcherLead', name: '포수 리드', tier: 'silver', type: 'build', desc: '포수 수비 80 이상이면 투수 제구 +12',
  ...
  { id: 'bottomUp', name: '하위 타선 강화', tier: 'gold', type: 'balance', desc: '종합 하위 타자 4명 능력치 +12',
  ...
  { id: 'bargain', name: '가성비 군단', tier: 'gold', type: 'build', desc: '영입가 72 이하 선수 능력치 +4',
  ...
  { id: 'emergency', name: '긴급 보강', tier: 'gold', type: 'balance', desc: '가장 약한 선수 1명의 능력치를 80으로',
  ...
  { id: 'doubleSwitch', name: '더블 스위치', tier: 'gold', type: 'play', desc: '선발이 내려가면 최고 불펜이 끝까지 · 불펜 능력치 +8',
  ...
  { id: 'underdog', name: '언더독의 반란', tier: 'prismatic', type: 'balance', desc: '상대 평균 종합이 우리보다 높으면 능력치 +10',
  ...
  { id: 'synCopy', name: '시너지 복사', tier: 'prismatic', type: 'build', desc: '가장 센 시너지를 팀 전원이 받음 · 능력치 +3',
  ...
  { id: 'oneMan', name: '원맨팀', tier: 'prismatic', type: 'extreme', desc: '종합 1위 선수 능력치 +25 · 나머지 전원 −1 · 1위가 타자면 타격 +12, 투수면 투구 +12',
  ...
  { id: 'dynasty', name: '원클럽 왕조', tier: 'prismatic', type: 'extreme', desc: '한 구단에서 4명 이상 뽑았으면 능력치 +7',
  ...
  { id: 'speedRevolution', name: '발야구 혁명', tier: 'prismatic', type: 'extreme', desc: '타자 주루 +20 · 타격은 주루 위주로 (주루 45% · 컨택 30% · 파워 25%)',
    roster: (r) => bump(r, isBat, { speed: 20 }), team: (t) => { t.weights = { contact: 0.3, power: 0.25, speed: 0.45 }; } },
  { id: 'flyballRevolution', name: '플라이볼 혁명', tier: 'prismatic', type: 'extreme', desc: '타자 파워 +16 · 타격은 파워 위주로 (파워 60% · 컨택 25% · 주루 15%)',
    roster: (r) => bump(r, isBat, { power: 16 }), team: (t) => { t.weights = { contact: 0.25, power: 0.6, speed: 0.15 }; } },
  { id: 'contactRevolution', name: '컨택 혁명', tier: 'prismatic', type: 'extreme', desc: '타자 컨택 +14 · 타격은 컨택 위주로 (컨택 60% · 파워 25% · 주루 15%)',
    roster: (r) => bump(r, isBat, { contact: 14 }), team: (t) => { t.weights = { contact: 0.6, power: 0.25, speed: 0.15 }; } },
  { id: 'defenseRevolution', name: '수비 혁명', tier: 'prismatic', type: 'extreme', desc: '야수 수비 +16 · 수비가 실점을 크게 줄임',
  ...
  { id: 'winStreak', name: '연승 기세', tier: 'prismatic', type: 'luck', desc: '이번 시즌 1승당 능력치 +2 (최대 +8)',
    roster: (r, env) => { const n = Math.min(8, (env.record?.w || 0) * 2); return n ? bump(r, () => true, every(n)) : r; } },
  { id: 'ironMan', name: '철인 선발', tier: 'prismatic', type: 'extreme', desc: '선발이 9회까지 완투 · 선발 능력치 +8',
