...
const PASSIVE_AUGMENTS = [
  ...
  { id: 'staminaTrain', name: '체력 훈련', tier: 'silver', type: 'build', desc: '투수 체력 +25 · 선발 이닝 +1',
    note: '선발이 늦게까지 버텨 불펜이 덜 나옴',
    roster: (r) => bump(r, isPit, { stamina: 25 }),
    team: (t) => { t.usage.extraInnings = (t.usage.extraInnings || 0) + 1; } },
  ...
  { id: 'speedRevolution', name: '발야구', tier: 'silver', type: 'extreme', desc: '타자 주루 +35 · 파워 −8',
  ...
  { id: 'setterUp', name: '테이블세터', tier: 'silver', type: 'build', desc: '주루 상위 4명 주루 +25',
  ...
  { id: 'aceKiller', name: '에이스 킬러', tier: 'silver', type: 'situ', desc: '상대 마운드가 종합 93+ 면 안타 확률 +8%',
    note: '상대 에이스를 만나도 밀리지 않음',
    half: (c) => (myOff(c) && (c.oppPitcher?.overall || 0) >= 93 ? { add: 0.4 } : null) },
